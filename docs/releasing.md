...
This repository ships to PyPI as `jakal-lit`.
...
```bash
python -m pip install --force-reinstall dist/jakal_lit-1.0.0-py3-none-any.whl
lit --help
python -m lit --help
```
...
1. Create the `jakal-lit` project on PyPI and TestPyPI.
